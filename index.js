...
document.getElementById('tab3').innerHTML='<a href="cos.html"><img class="clic" alt="image de produits cosmetiques" title="Cliquez ici" src="img8.jpg"><figcaption><strong>COSMETIQUES</strong></figcaption></a>';
//end img cosmetique
...
document.getElementById('tab4').innerHTML='<a href="tech.html"><img class="clic" alt="image de produits de technologies" title="Cliquez ici" src="img3.jpg"><figcaption><strong>UPSP TECH</strong></figcaption></a>';
//end img tech
...
document.getElementById('tab5').innerHTML='<a href="serv.html"><img class="clic" alt="image exemple de service" title="Cliquez ici" src="img4.jpg"><figcaption><strong>UPSP SERVICES</strong></figcaption></a>';
//end img services
