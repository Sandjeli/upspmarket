...
document.getElementById('tab1').innerHTML='<a href="food.html"><img class="clic" alt="image de nouritures" title="Cliquez ici" src="img/foods/'+imgfood+'.jpg"><figcaption><strong>FOODS UPSP</strong></figcaption></a>';
//end img food
...
document.getElementById('tab2').innerHTML='<a href="cloth.html"><img class="clic" alt="image de vêtements" title="Cliquez ici" src="img/cloths/'+imgcloths+'.jpg"><figcaption><strong>CLOTHES & SHOES</strong></figcaption></a>';
//end img cloths
...
document.getElementById('tab3').innerHTML='<a href="cos.html"><img class="clic" alt="image de produits cosmetiques" title="Cliquez ici" src="img/cosmétique/'+imgcosmetique+'.jpg"><figcaption><strong>COSMETIQUES</strong></figcaption></a>';
//end img cosmetique
...
document.getElementById('tab4').innerHTML='<a href="tech.html"><img class="clic" alt="image de produits de technologies" title="Cliquez ici" src="img/Tech/'+imgTech+'.jpg"><figcaption><strong>UPSP TECH</strong></figcaption></a>';
//end img tech
...
document.getElementById('tab5').innerHTML='<a href="serv.html"><img class="clic" alt="image exemple de service" title="Cliquez ici" src="img/service/'+imgService+'.jpg"><figcaption><strong>UPSP SERVICES</strong></figcaption></a>';
//end img services